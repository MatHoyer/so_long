...
/*   Updated: 2023/06/02 13:43:19 by mhoyer           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_texture_annexe(t_game *game)
{
	game->texture->perso[8].img = mlx_xpm_file_to_image(game->mlx,
			...
			&game->texture->perso[8].largeur, &game->texture->perso[8].largeur);
}
